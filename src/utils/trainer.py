...
class SupervisedTrainer(object):
    ...
    def _train_batch(self, input_variables, num_pos, input_lengths, span_length, target_variables, tree, model, batch_size):
    ...
    def _train_epoches(self, data_loader, model, batch_size, start_epoch, start_step, max_acc, n_epoch):
